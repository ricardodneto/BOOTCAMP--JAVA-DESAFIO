...
public class Desafio2{
        ...
        public static void main(String[] args) throws IOException {
            ...
            while (leitor.hasNext()) {
                double graus = Double.parseDouble(leitor.next());

                if (graus <= 360) {
                    if (graus < 90 || graus == 360) System.out.println("Bom Dia!!");
                    else if (graus >= 90 && graus < 180) System.out.println("Boa Tarde!!");
                    else if (graus >= 180 && graus <= 269) System.out.println("Boa Noite!!");
                    else if (graus > 269 && graus < 360) System.out.println("De Madrugada!!");
